...
## Sobre o projeto 
Aplicativo Web para controle de finanças pessoais dos usuários cadastrados. Desenvolvido para fornecer uma interface simples para as funcionalidades da [API REST](https://github.com/thomazcm/rest-api-financeira) que fornece o back-end para o funcionamento do aplicativo.
...
## Acesso
  ...
  Disponibiliza opções para cadastro ou para criação de uma conta temporária rápida para demonstração, já com vários registros a fim de facilitar a demonstração.
## Funcionalidades
